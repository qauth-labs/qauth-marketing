...
function PopoverHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return <div className={cn('flex flex-col gap-1 text-xs', className)} data-slot="popover-header" {...props} />
}

function PopoverTitle({ className, ...props }: React.ComponentProps<'h2'>) {
  return <div className={cn('font-medium text-sm', className)} data-slot="popover-title" {...props} />
}

function PopoverDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p className={cn('text-muted-foreground text-xs/relaxed', className)} data-slot="popover-description" {...props} />
  )
}
